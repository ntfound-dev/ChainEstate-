const PHASES = [
  {
    ...
    items: [
      ...
      { done: true,  text: 'ChainGPT AI assistant integration (streaming)' },
  ...
  },
  {
    ...
    items: [
      ...
      { done: false, text: 'Pin all property documents to IPFS via Pinata' },
      ...
      { done: false, text: 'Email notifications for rent distributions' },
    ],
  },
  {
    phase: 'Phase 2',
